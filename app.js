// === Intro to Number Theory - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('intro-number-theory-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('intro-number-theory-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
